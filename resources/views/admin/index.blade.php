                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-blue-50 p-6 rounded-lg border border-blue-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-blue-900">User Management</h3>
                                    <p class="text-blue-700">Manage all users, house owners, and tenants</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 p-6 rounded-lg border border-green-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-green-900">Property Management</h3>
                                    <p class="text-green-700">Oversee all properties and rental listings</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-purple-50 p-6 rounded-lg border border-purple-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-purple-900">System Reports</h3>
                                    <p class="text-purple-700">View comprehensive system analytics and reports</p>
                                </div>
                            </div>
                        </div>
                    </div>
